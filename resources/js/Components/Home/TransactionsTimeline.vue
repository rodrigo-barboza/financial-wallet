        ...
        <ol class="relative border-s border-gray-200">
            <li class="mb-10 ms-6">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900">
                    ...
                    <span
                        class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm ms-3">Latest</span>
                </h3>
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on January 13th,
                    2022</time>
                <p class="mb-4 text-base font-normal text-gray-500">Get access to over 20+ pages including a dashboard
                    layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
                <a href="#"
            ...
            <li class="ms-6">
                ...
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400">Released on December 2nd,
                    2021</time>
                <p class="text-base font-normal text-gray-500">Get started with dozens of web components and interactive
